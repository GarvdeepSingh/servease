  ...
  List onboarddata=[
    {
      "image":para1,
      "title":"Every service",
      "description":"Everyday services at any\n hour at your doorstep one\n click away!"
    },
    {
      "image":para,
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: TextButton(onPressed: continuemethod, child: Text('skip',style: TextStyle(color: color1,fontSize: 20),)),
          )
        ],
            ...
            return Column(children: [
              ...
              Text(
                ...
                style: const TextStyle(
                  ...
                  fontFamily: ba,),textAlign: TextAlign.center,
              ),
              const SizedBox(
                height: 20,
              ),
              Text(
                ...
                style: const TextStyle(
                  ...
                  fontFamily: ak,),textAlign: TextAlign.center,
              )
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: continuemethod, child: const Text('continue'),)
               :Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: List<Widget>.generate(onboarddata.length, (index){
